...
function rt(e2, r3, s3) {
  ...
  function O3(e3, r4) {
    return function(e4, r5, s4) {
      ...
      }(i4, r5, I(r5, f4, c4) || C), g4 = v3.as || h3, S4 = {};
      for (var w4 in v3)
        void 0 === v3[w4] || "$" === w4[0] || "as" === w4 || "theme" === w4 || ("forwardedAs" === w4 ? S4.as = v3.forwardedAs : y4 && !y4(w4, g4) || (S4[w4] = v3[w4], y4 || false || isPropValid(w4) || ot.has(w4) || !A.has(g4) || (ot.add(w4), console.warn('styled-components: it looks like an unknown prop "'.concat(w4, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      ...
      var E4 = ie(p4, d3);
      return b3 && (E4 += " " + b3), v3.className && (E4 += " " + v3.className), S4[L(g4) && !A.has(g4) ? "class" : "className"] = E4, S4.ref = s4, (0, import_react.createElement)(g4, S4);
    }(D3, e3, r4);
  }
  O3.displayName = y3;
  var D3 = import_react.default.forwardRef(O3);
  return D3.attrs = S3, D3.componentStyle = N3, D3.shouldForwardProp = w3, D3.displayName = y3, D3.foldedComponentIds = i3 ? ie(a2.foldedComponentIds, a2.styledComponentId) : "", D3.styledComponentId = g3, D3.target = i3 ? a2.target : e2, Object.defineProperty(D3, "defaultProps", { get: function() {
