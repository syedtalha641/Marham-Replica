...
var P = ut(k)`
  ...
  `};
    ...
    display: none;
  `};
	${({ hide: e2 }) => e2 && Number.isInteger(e2) && $(e2)`
    display: none;
  `};
`;
var D = at`
...
`;
var H = ut(P).attrs((e2) => ({ style: e2.style }))`
	${({ $renderAsCell: e2 }) => !e2 && D};
...
`;
var K = ut.div.attrs((e2) => ({ style: e2.style }))`
	display: flex;
	align-items: stretch;
...
function q({ columns: t2 = [], conditionalRowStyles: n = [], defaultExpanded: o = false, defaultExpanderDisabled: a = false, dense: l2 = false, expandableIcon: i2, expandableRows: s2 = false, expandableRowsComponent: d2, expandableRowsComponentProps: c2, expandableRowsHideExpander: g2, expandOnRowClicked: u2 = false, expandOnRowDoubleClicked: m2 = false, highlightOnHover: h2 = false, id: f2, expandableInheritConditionalStyles: x2, keyField: C2, onRowClicked: y2 = p, onRowDoubleClicked: R2 = p, onRowMouseEnter: v2 = p, onRowMouseLeave: S2 = p, onRowExpandToggled: E2 = p, onSelectedRow: O2 = p, pointerOnHover: $2 = false, row: k2, rowCount: P2, rowIndex: D2, selectableRowDisabled: H2 = null, selectableRows: j2 = false, selectableRowsComponent: I2, selectableRowsComponentProps: L2, selectableRowsHighlight: M2 = false, selectableRowsSingle: A2 = false, selected: N2, striped: W2 = false, draggingColumnId: B2, onDragStart: G2, onDragOver: V2, onDragEnd: U2, onDragEnter: Y2, onDragLeave: q2 }) {
  ...
  const X2 = e.useCallback(() => {
    Q2(!J2), E2(!J2, k2);
  }, [J2, E2, k2]), Z2 = $2 || s2 && (u2 || m2), ee2 = e.useCallback((e2) => {
    e2.target && "allowRowEvents" === e2.target.getAttribute("data-tag") && (y2(k2, e2), !a && s2 && u2 && X2());
  }, [a, u2, s2, X2, y2, k2]), te2 = e.useCallback((e2) => {
    e2.target && "allowRowEvents" === e2.target.getAttribute("data-tag") && (R2(k2, e2), !a && s2 && m2 && X2());
  }, [a, m2, s2, X2, R2, k2]), ne2 = e.useCallback((e2) => {
    v2(k2, e2);
  }, [v2, k2]), oe2 = e.useCallback((e2) => {
    S2(k2, e2);
  }, [S2, k2]), ae2 = r(k2, C2), { style: le2, classNames: re2 } = b(k2, n, ["rdt_TableRow"]), ie2 = M2 && N2, se2 = x2 ? le2 : {}, de2 = W2 && D2 % 2 == 0;
  return e.createElement(e.Fragment, null, e.createElement(K, { id: `row-${f2}`, role: "row", $striped: de2, $highlightOnHover: h2, $pointerOnHover: !a && Z2, $dense: l2, onClick: ee2, onDoubleClick: te2, onMouseEnter: ne2, onMouseLeave: oe2, className: re2, $selected: ie2, style: le2 }, j2 && e.createElement(T, { name: `select-row-${ae2}`, keyField: C2, row: k2, rowCount: P2, selected: N2, selectableRowsComponent: I2, selectableRowsComponentProps: L2, selectableRowDisabled: H2, selectableRowsSingle: A2, onSelectedRow: O2 }), s2 && !g2 && e.createElement(_, { id: ae2, expandableIcon: i2, expanded: J2, row: k2, onToggled: X2, disabled: a }), t2.map((t3) => t3.omit ? null : e.createElement(F, { id: `cell-${t3.id}-${ae2}`, key: `cell-${t3.id}-${ae2}`, dataTag: t3.ignoreRowClick || t3.button ? null : "allowRowEvents", column: t3, row: k2, rowIndex: D2, isDragging: w(B2, t3.id), onDragStart: G2, onDragOver: V2, onDragEnd: U2, onDragEnter: Y2, onDragLeave: q2 }))), s2 && J2 && e.createElement(z, { key: `expander-${ae2}`, data: k2, extendedRowStyle: se2, extendedClassNames: re2, ExpanderComponent: d2, expanderComponentProps: c2 }));
}
var J = ut.span`
	padding: 2px;
	color: inherit;
...
var ne = e.memo(function({ column: t2, disabled: n, draggingColumnId: o, selectedColumn: a = {}, sortDirection: r2, sortIcon: i2, sortServer: s2, pagination: d2, paginationServer: c2, persistSelectedOnSort: g2, selectableRowsVisibleOnly: u2, onSort: p2, onDragStart: b2, onDragOver: m2, onDragEnd: h2, onDragEnter: f2, onDragLeave: x2 }) {
  ...
  }, S2 = (t3) => e.createElement(Q, { sortActive: t3, sortDirection: r2 }), E2 = () => e.createElement("span", { className: [r2, "__rdt_custom_sort_icon__"].join(" ") }, i2), O2 = !(!t2.sortable || !w(a.id, t2.id)), $2 = !t2.sortable || n, k2 = t2.sortable && !i2 && !t2.right, P2 = t2.sortable && !i2 && t2.right, D2 = t2.sortable && i2 && !t2.right, H2 = t2.sortable && i2 && t2.right;
  return e.createElement(X, { "data-column-id": t2.id, className: "rdt_TableCol", $headCell: true, allowOverflow: t2.allowOverflow, button: t2.button, compact: t2.compact, grow: t2.grow, hide: t2.hide, maxWidth: t2.maxWidth, minWidth: t2.minWidth, right: t2.right, center: t2.center, width: t2.width, draggable: t2.reorder, $isDragging: w(t2.id, o), onDragStart: b2, onDragOver: m2, onDragEnd: h2, onDragEnter: f2, onDragLeave: x2 }, t2.name && e.createElement(ee, { "data-column-id": t2.id, "data-sort-id": t2.id, role: "columnheader", tabIndex: 0, className: "rdt_TableCol_Sortable", onClick: $2 ? void 0 : v2, onKeyPress: $2 ? void 0 : (e2) => {
    "Enter" === e2.key && v2();
...
var Le = e.memo(function({ rowsPerPage: t2, rowCount: n, currentPage: o, direction: a = ke.direction, paginationRowsPerPageOptions: l2 = ke.paginationRowsPerPageOptions, paginationIconLastPage: r2 = ke.paginationIconLastPage, paginationIconFirstPage: i2 = ke.paginationIconFirstPage, paginationIconNext: s2 = ke.paginationIconNext, paginationIconPrevious: d2 = ke.paginationIconPrevious, paginationComponentOptions: c2 = ke.paginationComponentOptions, onChangeRowsPerPage: u2 = ke.onChangeRowsPerPage, onChangePage: p2 = ke.onChangePage }) {
  ...
  })(), m2 = le(a), h2 = b2.width && b2.width > 599, w2 = g(n, t2), f2 = o * t2, x2 = f2 - t2 + 1, C2 = 1 === o, y2 = o === w2, R2 = Object.assign(Object.assign({}, Pe), c2), v2 = o === w2 ? `${x2}-${n} ${R2.rangeSeparatorText} ${n}` : `${x2}-${f2} ${R2.rangeSeparatorText} ${n}`, S2 = e.useCallback(() => p2(o - 1), [o, p2]), E2 = e.useCallback(() => p2(o + 1), [o, p2]), O2 = e.useCallback(() => p2(1), [p2]), $2 = e.useCallback(() => p2(g(n, t2)), [p2, n, t2]), k2 = e.useCallback((e2) => u2(Number(e2.target.value), o), [o, u2]), P2 = l2.map((t3) => e.createElement("option", { key: t3, value: t3 }, t3));
...
var Qe = e.memo(function(t2) {
  const { data: n = ke.data, columns: o = ke.columns, title: s2 = ke.title, actions: d2 = ke.actions, keyField: c2 = ke.keyField, striped: p2 = ke.striped, highlightOnHover: b2 = ke.highlightOnHover, pointerOnHover: h2 = ke.pointerOnHover, dense: w2 = ke.dense, selectableRows: x2 = ke.selectableRows, selectableRowsSingle: y2 = ke.selectableRowsSingle, selectableRowsHighlight: S2 = ke.selectableRowsHighlight, selectableRowsNoSelectAll: E2 = ke.selectableRowsNoSelectAll, selectableRowsVisibleOnly: O2 = ke.selectableRowsVisibleOnly, selectableRowSelected: $2 = ke.selectableRowSelected, selectableRowDisabled: P2 = ke.selectableRowDisabled, selectableRowsComponent: D2 = ke.selectableRowsComponent, selectableRowsComponentProps: H2 = ke.selectableRowsComponentProps, onRowExpandToggled: F2 = ke.onRowExpandToggled, onSelectedRowsChange: j2 = ke.onSelectedRowsChange, expandableIcon: I2 = ke.expandableIcon, onChangeRowsPerPage: T2 = ke.onChangeRowsPerPage, onChangePage: L2 = ke.onChangePage, paginationServer: M2 = ke.paginationServer, paginationServerOptions: A2 = ke.paginationServerOptions, paginationTotalRows: _2 = ke.paginationTotalRows, paginationDefaultPage: N2 = ke.paginationDefaultPage, paginationResetDefaultPage: z2 = ke.paginationResetDefaultPage, paginationPerPage: W2 = ke.paginationPerPage, paginationRowsPerPageOptions: B2 = ke.paginationRowsPerPageOptions, paginationIconLastPage: G2 = ke.paginationIconLastPage, paginationIconFirstPage: V2 = ke.paginationIconFirstPage, paginationIconNext: U2 = ke.paginationIconNext, paginationIconPrevious: Y2 = ke.paginationIconPrevious, paginationComponent: K2 = ke.paginationComponent, paginationComponentOptions: J2 = ke.paginationComponentOptions, responsive: Q2 = ke.responsive, progressPending: X2 = ke.progressPending, progressComponent: Z2 = ke.progressComponent, persistTableHead: ee2 = ke.persistTableHead, noDataComponent: te2 = ke.noDataComponent, disabled: oe2 = ke.disabled, noTableHead: le2 = ke.noTableHead, noHeader: re2 = ke.noHeader, fixedHeader: ie2 = ke.fixedHeader, fixedHeaderScrollHeight: se2 = ke.fixedHeaderScrollHeight, pagination: de2 = ke.pagination, subHeader: ce2 = ke.subHeader, subHeaderAlign: ge2 = ke.subHeaderAlign, subHeaderWrap: ue2 = ke.subHeaderWrap, subHeaderComponent: be2 = ke.subHeaderComponent, noContextMenu: me2 = ke.noContextMenu, contextMessage: he2 = ke.contextMessage, contextActions: Se2 = ke.contextActions, contextComponent: Ee2 = ke.contextComponent, expandableRows: Oe2 = ke.expandableRows, onRowClicked: $e2 = ke.onRowClicked, onRowDoubleClicked: Pe2 = ke.onRowDoubleClicked, onRowMouseEnter: De2 = ke.onRowMouseEnter, onRowMouseLeave: He2 = ke.onRowMouseLeave, sortIcon: Fe2 = ke.sortIcon, onSort: je2 = ke.onSort, sortFunction: Ie2 = ke.sortFunction, sortServer: Te2 = ke.sortServer, expandableRowsComponent: Ae2 = ke.expandableRowsComponent, expandableRowsComponentProps: _e2 = ke.expandableRowsComponentProps, expandableRowDisabled: Ne2 = ke.expandableRowDisabled, expandableRowsHideExpander: ze2 = ke.expandableRowsHideExpander, expandOnRowClicked: We2 = ke.expandOnRowClicked, expandOnRowDoubleClicked: Be2 = ke.expandOnRowDoubleClicked, expandableRowExpanded: Ge2 = ke.expandableRowExpanded, expandableInheritConditionalStyles: Ve2 = ke.expandableInheritConditionalStyles, defaultSortFieldId: Ye2 = ke.defaultSortFieldId, defaultSortAsc: qe2 = ke.defaultSortAsc, clearSelectedRows: Qe2 = ke.clearSelectedRows, conditionalRowStyles: Xe = ke.conditionalRowStyles, theme: Ze = ke.theme, customStyles: et = ke.customStyles, direction: tt2 = ke.direction, onColumnOrderChange: nt = ke.onColumnOrderChange, className: ot } = t2, { tableColumns: at2, draggingColumnId: lt, handleDragStart: rt, handleDragEnter: it, handleDragOver: st, handleDragLeave: dt, handleDragEnd: ct, defaultSortDirection: gt, defaultSortColumn: ut2 } = Je(o, nt, Ye2, qe2), [{ rowsPerPage: pt, currentPage: bt, selectedRows: mt, allSelected: ht, selectedCount: wt, selectedColumn: ft, sortDirection: xt, toggleOnSelectedRowsChange: Ct }, yt] = e.useReducer(f, { allSelected: false, selectedCount: 0, selectedRows: [], selectedColumn: ut2, toggleOnSelectedRowsChange: false, sortDirection: gt, currentPage: N2, rowsPerPage: W2, selectedRowsFlag: false, contextMessage: ke.contextMessage }), { persistSelectedOnSort: Rt = false, persistSelectedOnPageChange: vt = false } = A2, St = !(!M2 || !vt && !Rt), Et = de2 && !X2 && n.length > 0, Ot = K2 || Le, $t = e.useMemo(() => ((e2 = {}, t3 = "default", n2 = "default") => {
    ...
    var a;
  })(et, Ze), [et, Ze]), kt = e.useMemo(() => Object.assign({}, "auto" !== tt2 && { dir: tt2 }), [tt2]), Pt = e.useMemo(() => {
    if (Te2)
      return n;
  ...
  }, [Te2, ft, xt, n, Ie2]), Dt = e.useMemo(() => {
    if (de2 && !M2) {
      const e2 = bt * pt, t3 = e2 - pt;
      return Pt.slice(t3, e2);
    }
    return Pt;
  }, [bt, de2, M2, pt, Pt]), Ht = e.useCallback((e2) => {
    yt(e2);
  }, []), Ft = e.useCallback((e2) => {
    yt(e2);
  }, []), jt = e.useCallback((e2) => {
    yt(e2);
  }, []), It = e.useCallback((e2, t3) => $e2(e2, t3), [$e2]), Tt = e.useCallback((e2, t3) => Pe2(e2, t3), [Pe2]), Lt = e.useCallback((e2, t3) => De2(e2, t3), [De2]), Mt = e.useCallback((e2, t3) => He2(e2, t3), [He2]), At = e.useCallback((e2) => yt({ type: "CHANGE_PAGE", page: e2, paginationServer: M2, visibleOnly: O2, persistSelectedOnPageChange: vt }), [M2, vt, O2]), _t = e.useCallback((e2) => {
    const t3 = g(_2 || Dt.length, e2), n2 = u(bt, t3);
    M2 || At(n2), yt({ type: "CHANGE_ROWS_PER_PAGE", page: n2, rowsPerPage: e2 });
  }, [bt, At, M2, _2, Dt.length]);
  if (de2 && !M2 && Pt.length > 0 && 0 === Dt.length) {
    const e2 = g(Pt.length, pt), t3 = u(bt, e2);
    At(t3);
  }
  Me(() => {
    j2({ allSelected: ht, selectedCount: wt, selectedRows: mt.slice(0) });
  }, [Ct]), Me(() => {
    je2(ft, xt, Pt.slice(0));
  }, [ft, xt]), Me(() => {
    L2(bt, _2 || Pt.length);
  }, [bt]), Me(() => {
    T2(pt, bt);
    ...
    if (!$2)
      return;
    const e2 = Pt.filter((e3) => $2(e3)), t3 = y2 ? e2.slice(0, 1) : e2;
    yt({ type: "SELECT_MULTIPLE_ROWS", keyField: c2, selectedRows: t3, totalRows: Pt.length, mergeSelections: St });
  }, [n, $2]);
  const Nt = O2 ? Dt : Pt, zt = vt || y2 || E2;
  return e.createElement(tt, { theme: $t }, !re2 && (!!s2 || !!d2) && e.createElement(pe, { title: s2, actions: d2, showMenu: !me2, selectedCount: wt, direction: tt2, contextActions: Se2, contextComponent: Ee2, contextMessage: he2 }), ce2 && e.createElement(we, { align: ge2, wrapContent: ue2 }, be2), e.createElement(xe, Object.assign({ $responsive: Q2, $fixedHeader: ie2, $fixedHeaderScrollHeight: se2, className: ot }, kt), e.createElement(ye, null, X2 && !ee2 && e.createElement(Ce, null, Z2), e.createElement(C, { disabled: oe2, className: "rdt_Table", role: "table" }, !le2 && (!!ee2 || Pt.length > 0 && !X2) && e.createElement(R, { className: "rdt_TableHead", role: "rowgroup", $fixedHeader: ie2 }, e.createElement(v, { className: "rdt_TableHeadRow", role: "row", $dense: w2 }, x2 && (zt ? e.createElement(k, { style: { flex: "0 0 48px" } }) : e.createElement(ae, { allSelected: ht, selectedRows: mt, selectableRowsComponent: D2, selectableRowsComponentProps: H2, selectableRowDisabled: P2, rowData: Nt, keyField: c2, mergeSelections: St, onSelectAllRows: Ft })), Oe2 && !ze2 && e.createElement(Re, null), at2.map((t3) => e.createElement(ne, { key: t3.id, column: t3, selectedColumn: ft, disabled: X2 || 0 === Pt.length, pagination: de2, paginationServer: M2, persistSelectedOnSort: Rt, selectableRowsVisibleOnly: O2, sortDirection: xt, sortIcon: Fe2, sortServer: Te2, onSort: Ht, onDragStart: rt, onDragOver: st, onDragEnd: ct, onDragEnter: it, onDragLeave: dt, draggingColumnId: lt })))), !Pt.length && !X2 && e.createElement(ve, null, te2), X2 && ee2 && e.createElement(Ce, null, Z2), !X2 && Pt.length > 0 && e.createElement(fe, { className: "rdt_TableBody", role: "rowgroup" }, Dt.map((t3, n2) => {
    ...
    return e.createElement(q, { id: a, key: a, keyField: c2, "data-row-id": a, columns: at2, row: t3, rowCount: Pt.length, rowIndex: n2, selectableRows: x2, expandableRows: Oe2, expandableIcon: I2, highlightOnHover: b2, pointerOnHover: h2, dense: w2, expandOnRowClicked: We2, expandOnRowDoubleClicked: Be2, expandableRowsComponent: Ae2, expandableRowsComponentProps: _e2, expandableRowsHideExpander: ze2, defaultExpanderDisabled: s3, defaultExpanded: i2, expandableInheritConditionalStyles: Ve2, conditionalRowStyles: Xe, selected: l2, selectableRowsHighlight: S2, selectableRowsComponent: D2, selectableRowsComponentProps: H2, selectableRowDisabled: P2, selectableRowsSingle: y2, striped: p2, onRowExpandToggled: F2, onRowClicked: It, onRowDoubleClicked: Tt, onRowMouseEnter: Lt, onRowMouseLeave: Mt, onSelectedRow: jt, draggingColumnId: lt, onDragStart: rt, onDragOver: st, onDragEnd: ct, onDragEnter: it, onDragLeave: dt });
  }))))), Et && e.createElement("div", null, e.createElement(Ot, { onChangePage: At, onChangeRowsPerPage: _t, rowCount: _2 || Pt.length, currentPage: bt, rowsPerPage: pt, direction: tt2, paginationRowsPerPageOptions: B2, paginationIconLastPage: G2, paginationIconFirstPage: V2, paginationIconNext: U2, paginationIconPrevious: Y2, paginationComponentOptions: J2 })));
});
export {
  G as Alignment,
  B as Direction,
